    ...
    <div data-testid="admin-logs">
      ...
      <div className="flex gap-4 mb-6">
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium ${activeTab === 'admin' ? 'bg-black text-white' : 'bg-gray-200'
            }`}
        >
        ...
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium ${activeTab === 'security' ? 'bg-black text-white' : 'bg-gray-200'
            }`}
        >
